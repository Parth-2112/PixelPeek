...
const Videos = () => {
    ...
    const descArr = [
        { heading: "Sample Video 1", desc: "This is a sample video for texting and demo. It is basically a description" },
        { heading: "Sample Video 2", desc: "This is a sample video for texting and demo. It is basically a description" },
        { heading: "Sample Video 3", desc: "This is a sample video for texting and demo. It is basically a description" },
        { heading: "Sample Video 4", desc: "This is a sample video for texting and demo. It is basically a description" },
        { heading: "Sample Video 5", desc: "This is a sample video for texting and demo. It is basically a description" },
        { heading: "Sample Video 6", desc: "This is a sample video for texting and demo. It is basically a description" },
        { heading: "Sample Video 7", desc: "This is a sample video for texting and demo. It is basically a description" }
    ];
    
    const [videoSrc,setVideoSrc] = useState(videosArr[0]);
    const [descSrc, setDescSrc] = useState(descArr[0]);
    ...
    >
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p='8' w={'full'} overflowY={'auto'}>
                <Heading>{descSrc.heading}</Heading>
                <Text>{descSrc.desc}</Text>
            </VStack>
        </VStack>
